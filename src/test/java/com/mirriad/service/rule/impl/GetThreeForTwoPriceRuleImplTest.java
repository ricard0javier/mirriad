...
/**
 * Test suite for the class {@link GetThreeForTwoPriceRuleImpl}
 */
public class GetThreeForTwoPriceRuleImplTest {
    ...
    private GetThreeForTwoPriceRuleImpl target;
    ...
    public void setUp() throws Exception {
        ...
        target = new GetThreeForTwoPriceRuleImpl();
    ...
    public void testRuleIsApplied() throws Exception {
        ...
        assertEquals(ITEM_UNIT_PRICE, actual.getDiscount(), 0.01);
